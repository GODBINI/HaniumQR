...
public class GuestMsgAdapter extends RecyclerView.Adapter <GuestMsgAdapter.ItemViewHolder>{
    // adapter에 들어갈 list 입니다.
    private ArrayList<GuestMsgData> listData = new ArrayList<>();

    @NonNull
    @Override
    public GuestMsgAdapter.ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new GuestMsgAdapter.ItemViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull GuestMsgAdapter.ItemViewHolder holder, int position) {
